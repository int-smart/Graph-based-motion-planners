...
if __name__ == "__main__":
    ...
    with env:
        ...
        getPath = Anastar(startconfig, goalconfig, env, robot, heuristic, connectionType, stepSizeX, stepSizeY, stepSizeTheta, tolValue)

        #### Draw the X and Y components of the configurations explored by your algorithm

        path = getPath  # put your final path in this variable
        if path is None:
